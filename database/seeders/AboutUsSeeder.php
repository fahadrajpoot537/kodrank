        ...
        $page = ServicePage::query()->updateOrCreate(
            ...
            [
                ...
                'seo' => [
                    ...
                    'seo_description' => 'Founded by two professionals. One team, one price — SEO, web development, and content without phased agency invoices.',
                    'og_title' => 'About KodRank — We\'re Not An Agency, We\'re Your Technical Team',
                    'og_description' => 'Founded by two professionals. One team, one price — SEO, web development, and content without phased agency invoices.',
        ...
        $sections = [
            [
                ...
                'data' => [
                    ...
                    'lede' => 'Founded by two professionals who got tired of watching agencies milk clients phase by phase. So we built the alternative: one team, one price, everything solved.',
                    'lede_html' => 'Founded by two professionals who got tired of watching agencies milk clients phase by phase. So we built the alternative: <span class="accent">one team, one price, everything solved.</span>',
            ...
            [
                ...
                'data' => [
                    'eyebrow' => '— Leadership',
                    'title' => 'Two specialists. No layers between.',
                    'title_html' => 'Two specialists.<br>No layers between.',
