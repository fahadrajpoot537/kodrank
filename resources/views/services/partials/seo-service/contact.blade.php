@php
  $ct = $s['contact'] ?? [];
  $fields = $ct['fields'] ?? [];
  $pageType = str_contains($page->slug ?? '', 'off-page') ? 'off_page' : 'on_page';
...
<section id="contact" class="sec-mist">
  <div class="wrap">
    <div class="contact-grid">
      ...
      <form class="contact-card" id="svcContactForm" method="POST" action="{{ route('seo-services.inquiry.store') }}">
        @csrf
