...
@endphp
@if(!empty($cards))
<section id="why" class="sec-mist rest-why">
  <div class="wrap">
    ...
    <div class="svc-carousel page-svc-carousel rest-why-carousel" data-sp-carousel data-per-desktop="3">
      <button type="button" class="svc-nav svc-prev" aria-label="Previous">{!! $arrow !!}</button>
      <div class="svc-viewport">
        <div class="svc-track">
          @foreach($cards as $card)
            <article class="why svc-slide">
              <div class="tile">
