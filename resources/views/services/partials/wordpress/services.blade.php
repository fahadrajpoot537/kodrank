...
@endphp
<section id="services" class="sec-paper">
  <div class="wrap">
        ...
        <div class="svc-track">
          @foreach($d['cards'] ?? [] as $card)
            <article class="svc-card svc-slide">
              <div class="check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12l5 5L20 7"/></svg></div>
