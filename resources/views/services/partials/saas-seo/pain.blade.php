@php $d = $s['pain'] ?? []; @endphp
<section class="sec-mist" id="pain">
  <div class="wrap">
    <div class="shead">
      ...
      <div class="svc-viewport"><div class="svc-track">
        @foreach($d['cards'] ?? [] as $card)
          <div class="pain svc-slide">
            <div class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a9 9 0 1 0 9 9"/><path d="M12 7v5l3 2"/></svg></div>
            <h4>{{ $card['title'] ?? '' }}</h4>
            <p>{{ $card['body'] ?? '' }}</p>
          </div>
        @endforeach
